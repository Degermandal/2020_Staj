...
public class YapiKrediAccount extends Fragment {
    PieChart pieChart;
    PieData pieData;
    ...
    private void getEntries() {
        ...
        pieEntries.add(new PieEntry(3f, "Değerli Madenler"));
        pieEntries.add(new PieEntry(1f, "Döviz"));
        pieEntries.add(new PieEntry(4f, "Hisse"));
